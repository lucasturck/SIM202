...
int main()
{
    ...
    dynamic_cast<Connexion*>(c2)->initC(1, nbneur);
    for (int i = 1; i <= nbneur; i++){
        dynamic_cast<Connexion*>(c2)->mat_C(1, i) = 1.0;
    }
    ...
    Entier n = 1;// nbneur*100; // Nombre d'exemples
