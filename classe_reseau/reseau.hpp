...
public:
   ...
   Reseau(const initializer_list<Couche*>& vs, const string& nom="non_def") : couches(vector<Couche*>{vs}), name(nom), residus(vecteur(1,0)){}; //Creation d un reseau à l'aide d une liste de couches et d'un nom
